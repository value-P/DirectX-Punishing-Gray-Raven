...
{
	if (FAILED(m_pGameInstance.lock()->Add_Object(LEVEL_LOGO, strLayerTag, CBackGround::Create(m_pDevice, m_pContext, L"Logo",Vector3(0.f,0.f,0.f)), &g_TimeScale_Player)))
		return E_FAIL;
